...
# save
train.to_csv("Data/DE/2021/clean/de_train.csv", index=False)
test.to_csv("Data/DE/2021/clean/de_test.csv", index=False)
...
for i,q in enumerate(tqdm(quantiles)):
    ...
    pickle.dump(qr_krn_models[i], open(f'train_test/DE/models/krn_qr_{q}.pkl', 'wb'))
